...
namespace ExamStation.Controllers
{
    public class NoticesController : Controller
    {
        ...
        public NoticesController(ExamStationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Date,WriteNotice")] Notice notice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Date,WriteNotice")] Notice notice)
        {
            if (id != notice.Id)
            {
                return NotFound();
