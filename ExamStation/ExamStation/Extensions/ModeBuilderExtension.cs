    ...
    public static class ModeBuilderExtension
    {
        public static void Seed(this ModelBuilder modeBuilder)
        {
            ...
            modeBuilder.Entity<QuestionBank>().HasData(
                new QuestionBank { Id = 1, QuestionGroup = "Science", DifficultyLevel = "Easy", Question ="What is Computer", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType="Single Answer" },
                new QuestionBank { Id = 2, QuestionGroup = "Science", DifficultyLevel = "Easy", Question ="What is Computer Describe it", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType="Single Answer" },
                new QuestionBank { Id = 3, QuestionGroup = "Math", DifficultyLevel = "Very Easy", Question = "What is Math", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType="Multi Answer" },
                new QuestionBank { Id = 4, QuestionGroup = "Math", DifficultyLevel = "Very Easy", Question = "What is Math Describe it", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType="Multi Answer" },
                new QuestionBank { Id = 5, QuestionGroup = "Chemistry", DifficultyLevel = "Medium", Question = "What is Chemistry", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType="Fill In The Blanks" },
                new QuestionBank { Id = 6, QuestionGroup = "Chemistry", DifficultyLevel = "Medium", Question = "What is Chemistry Describe it", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType="Fill In The Blanks" },
                new QuestionBank { Id = 7, QuestionGroup = "General Knowledge", DifficultyLevel = "Hard", Question = "What is General Knowledge", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType= "Single Answer" },
                new QuestionBank { Id = 8, QuestionGroup = "General Knowledge", DifficultyLevel = "Hard", Question = "What is General Knowledge Describe it", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType= "Single Answer" },
                new QuestionBank { Id = 9, QuestionGroup = "Computer Science", DifficultyLevel = "Easy", Question = "What is Computer Science", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType= "Multi Answer" },
                new QuestionBank { Id = 10, QuestionGroup = "Computer Science", DifficultyLevel = "Easy", Question = "What is Computer Science Describe it", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType= "Multi Answer" }
               );
