    ...
    public static class ModeBuilderExtension
    {
        public static void Seed(this ModelBuilder modeBuilder)
        {
            modeBuilder.Entity<Student>().HasData(
                new Student { StudentId = 1, StudentName = "Saif", Guardian = "Abu Siddik", DateOfBirth = Convert.ToDateTime("16-05-2002"), Gender ="Male", BloodGroup = "B-", Religion = "Muslim", Email = "saif100@gmail.com", Phone = 01548959585, State= "Islambagh", Country= "Bangladesh", Class = "One", Section="A", Group = "Science", OptionalSubject= "", RegisterNo = 1010, Roll = 1, Photo= "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", ExtraActivities = "Nothing", Remarks = "Student-1" },
                new Student { StudentId = 2, StudentName = "Asif", Guardian = "Ruma", DateOfBirth = Convert.ToDateTime("01-03-2006"), Gender ="Male", BloodGroup = "A+", Religion = "Muslim", Email = "asif100@gmail.com", Phone = 0154895896, State= "Islambagh", Country= "Bangladesh", Class = "Two", Section="B", Group = "Computer Science", OptionalSubject= "", RegisterNo = 1011, Roll = 2, Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", ExtraActivities = "Nothing", Remarks = "Student-2" },
                new Student { StudentId = 3, StudentName = "Musa", Guardian = "Kamrunnahar", DateOfBirth = Convert.ToDateTime("02-04-2011"), Gender ="Male", BloodGroup = "AB+", Religion = "Muslim", Email = "musa100@gmail.com", Phone = 0168548958, State= "Islambagh", Country= "Bangladesh", Class = "Three", Section="C", Group = "General Knowledge", OptionalSubject= "", RegisterNo = 1012, Roll = 3, Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", ExtraActivities = "Nothing", Remarks = "Student-3" },
                new Student { StudentId = 4, StudentName = "Saad", Guardian = "Jewel", DateOfBirth = Convert.ToDateTime("08-09-2011"), Gender ="Male", BloodGroup = "A-", Religion = "Muslim", Email = "saad100@gmail.com", Phone = 0198758485, State= "Dhaka", Country= "Bangladesh", Class = "Four", Section="D", Group = "Math", OptionalSubject= "", RegisterNo = 1013, Roll = 1, Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", ExtraActivities = "Nothing", Remarks = "Student-4" },
                new Student { StudentId = 5, StudentName = "Ayisha", Guardian = "Zaman", DateOfBirth = Convert.ToDateTime("01-02-2018"), Gender ="Female", BloodGroup = "B+", Religion = "Muslim", Email = "ayisha100@gmail.com", Phone = 0178458723, State= "Dhaka", Country= "Bangladesh", Class = "Five", Section="E", Group = "Chemistry", OptionalSubject= "", RegisterNo = 1014, Roll = 4, Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", ExtraActivities = "Nothing", Remarks = "Student-5" }               
            );

            modeBuilder.Entity<Parent>().HasData(
                new Parent { GuardianId = 1, GuardianName = "Abu Siddik", FatherName = "Abu Siddik", MotherName = "MST Ruma", FatherProfession = "Teacher", MotherProfession = "Teacher", Email = "siddik100@gmail.com", Phone = 0115847895, Address ="Islambagh", Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", },
                new Parent { GuardianId = 2, GuardianName = "Ruma", FatherName = "Abu Siddik", MotherName = "MST Ruma", FatherProfession = "Teacher", MotherProfession = "Teacher", Email = "siddik100@gmail.com", Phone = 0115847895, Address ="Islambagh", Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", },
                new Parent { GuardianId = 3, GuardianName = "Kamrunnahar", FatherName = "Abu Siddik", MotherName = "MST Ruma", FatherProfession = "Teacher", MotherProfession = "Teacher", Email = "siddik100@gmail.com", Phone = 0115847895, Address ="Islambagh", Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", },
                new Parent { GuardianId = 4, GuardianName = "Jewel", FatherName = "Jewel", MotherName = "Shimu", FatherProfession = "Software Engineer", MotherProfession = "Teacher", Email = "jewel100@gmail.com", Phone = 0115847895, Address ="Dhaka", Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", },
                new Parent { GuardianId = 5, GuardianName = "Zaman", FatherName = "Zaman", MotherName = "MST Shimu", FatherProfession = "Software Engineer", MotherProfession = "Teacher", Email = "jewel100@gmail.com", Phone = 0115847895, Address ="Dhaka", Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", }
                );

            modeBuilder.Entity<Teacher>().HasData(
                new Teacher { TeacherId = 1, TeacherName = "Hasan", Designation = "Software Engineer", DateOfBirth = Convert.ToDateTime("01-08-1997"), Gender = "Male", Religion = "Muslim", Email = "hasan100@gmail.com", Phone = 01234567895, Address = "Islambagh", JoiningDate = Convert.ToDateTime("01-10-2020"), Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", },
                new Teacher { TeacherId = 2, TeacherName = "Rakib", Designation = "Software Developer", DateOfBirth = Convert.ToDateTime("25-05-1995"), Gender = "Male", Religion = "Muslim", Email = "rakib100@gmail.com", Phone = 01254621458, Address = "Dhaka", JoiningDate = Convert.ToDateTime("02-10-2020"), Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", },
                new Teacher { TeacherId = 3, TeacherName = "Imran", Designation = "Programmer", DateOfBirth = Convert.ToDateTime("01-09-1991"), Gender = "Male", Religion = "Muslim", Email = "imran100@gmail.com", Phone = 01201201456, Address = "Dhaka", JoiningDate = Convert.ToDateTime("03-10-2020"), Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", },
                new Teacher { TeacherId = 4, TeacherName = "Masum", Designation = "ICT Specialist", DateOfBirth = Convert.ToDateTime("16-02-1996"), Gender = "Male", Religion = "Muslim", Email = "masum100@gmail.com", Phone = 01245154789, Address = "Dhaka", JoiningDate = Convert.ToDateTime("04-10-2020"), Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", },
                new Teacher { TeacherId = 5, TeacherName = "Rafi", Designation = "Developer", DateOfBirth = Convert.ToDateTime("30-07-1995"), Gender = "Male", Religion = "Muslim", Email = "rafi100@gmail.com", Phone = 01452548514, Address = "Dhaka", JoiningDate = Convert.ToDateTime("05-10-2020"), Photo = "d5a3b4f1-faad-48a5-b438-8109d1f9be69_hasan.jpg", }
               );
            ...
            new QuestionBank { Id = 1,  DifficultyLevelId = 1, Question ="What is Computer", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType="Single Answer"                     },
            new QuestionBank { Id = 2, DifficultyLevelId = 1, Question ="What is Computer Describe it", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType="Single Answer" },
            new QuestionBank { Id = 3, DifficultyLevelId = 2, Question = "What is Math", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType="Multi Answer" },
            new QuestionBank { Id = 4, DifficultyLevelId = 2, Question = "What is Math Describe it", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType="Multi Answer" },
            new QuestionBank { Id = 5, DifficultyLevelId = 3, Question = "What is Chemistry", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType="Fill In The Blanks" },
            new QuestionBank { Id = 6, DifficultyLevelId = 3, Question = "What is Chemistry Describe it", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType="Fill In The Blanks" },
            new QuestionBank { Id = 7, DifficultyLevelId = 4, Question = "What is General Knowledge", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType= "Single Answer" },
            new QuestionBank { Id = 8, DifficultyLevelId = 4, Question = "What is General Knowledge Describe it", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType= "Single Answer" },
            new QuestionBank { Id = 9, DifficultyLevelId = 1, Question = "What is Computer Science", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType= "Multi Answer" },
            new QuestionBank { Id = 10, DifficultyLevelId = 1, Question = "What is Computer Science Describe it", Explanation= "a programmable electronic device designed to accept data, perform prescribed mathematical and logical operations at high speed, and display the results of these operations.", Hints="Nothing", Mark=40, QuestionType= "Multi Answer" }
              );
